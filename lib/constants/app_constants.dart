...
final restaurantLargeImageUrl = "$baseUrl/images/large/";
final restaurantMediumImageUrl = "$baseUrl/images/medium/";
final restaurantSmallImageUrl = "$baseUrl/images/small/";
